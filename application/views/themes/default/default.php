        ...
        <div class="container">
          ...
          <div style="height: 0px;" class="nav-collapse collapse">
            <ul class="nav">
			  ...
			  <li><a href="<?php echo site_url('examplesimplicity/example_1'); ?>">Example 1</a></li>
              <li><a href="<?php echo site_url('examplesimplicity/example_2'); ?>">Example 2</a></li>
              <li><a href="<?php echo site_url('examplesimplicity/example_3'); ?>">Example 3</a></li>
              <li><a href="<?php echo site_url('examplesimplicity/example_4'); ?>">Example 4</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
